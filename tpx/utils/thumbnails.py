...
from tpx.Dev.dataclass import CachedTrack
from tpx import app

FONTS = {
    "cfont": ImageFont.truetype("tpx/BtwToxic/cfont.ttf", 15),
    "dfont": ImageFont.truetype("tpx/BtwToxic/font2.otf", 12),
    "nfont": ImageFont.truetype("tpx/BtwToxic/font.ttf", 10),
    "tfont": ImageFont.truetype("tpx/BtwToxic/font.ttf", 20),
}
...
def add_controls(img: Image.Image) -> Image.Image:
    ...
    region = img.crop(box)
    controls = Image.open("tpx/BtwToxic/controls.png").convert("RGBA")
...
async def gen_thumb(song: CachedTrack) -> str:
    ...
    draw.text((285, 180), "Toxic Dev @idc_toxic", (192, 192, 192), font=FONTS["nfont"])
